  ...
  <div>
    <div class="gva-search-box">
      <el-form ref="elSearchFormRef" :inline="true" :model="searchInfo" class="demo-form-inline"
        ...
        <el-form-item label="开始时间" prop="startDate">
          ...
          <el-date-picker class="!w-380px" v-model="searchInfo.startDateRange" type="datetimerange" range-separator="至"
            start-placeholder="开始时间" end-placeholder="结束时间"></el-date-picker></el-form-item>
        ...
        <el-form-item label="结束时间" prop="endDate">
          ...
          <el-date-picker class="!w-380px" v-model="searchInfo.endDateRange" type="datetimerange" range-separator="至"
            start-placeholder="开始时间" end-placeholder="结束时间"></el-date-picker></el-form-item>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        ...
        <ImportExcel v-auth="btnAuth.importExcel" template-id="resume_ResumeWorkExperience"
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
          <template #default="scope">
            ...
            <el-button v-auth="btnAuth.edit" type="primary" link icon="edit" class="table-button"
              @click="updateResumeWorkExperienceFunc(scope.row)">编辑</el-button>
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="dialogFormVisible" :show-close="false"
      ...
      <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="开始时间:" prop="startDate">
          <el-date-picker v-model="formData.startDate" type="date" style="width:100%" placeholder="选择日期"
            :clearable="true" />
        </el-form-item>
        <el-form-item label="结束时间:" prop="endDate">
        ...
        <el-form-item label="是否当前工作:" prop="isCurrent">
          <el-switch v-model="formData.isCurrent" active-color="#13ce66" inactive-color="#ff4949" active-text="是"
